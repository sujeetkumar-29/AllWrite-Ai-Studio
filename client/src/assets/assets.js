...
import { SquarePen, Hash, Image, Eraser, Scissors, FileText, BookOpen, Mail, FileType,User, MessagesSquare } from 'lucide-react'
...
export const AiToolsData = [
    ...
    },
    {
        ...
        description: 'Create captivating stories in various genres with our AI storytelling tool.',
        Icon: BookOpen,
        bg: { from: '#FF6B35', to: '#F7931E' },
        path: '/ai/generate-story'
    },
    {
        title: 'Email Writer',
    ...
    },
    {
        ...
        description: 'Quickly summarize long texts and documents with AI-powered analysis.',
        Icon: FileType,
    ...
    },
    {
        ...
        description: 'Prepare for interviews with AI-generated questions and answers.',
        Icon: MessagesSquare,
        bg: { from: '#4FACFE', to: '#00F2FE' },
        path: '/ai/interview-qa'
    },
    {
        title: 'Portfolio Bio Generator',
        description: 'Create compelling portfolio bios that showcase your professional story.',
        Icon: User,
        bg: { from: '#FA709A', to: '#FEE140' },
        path: '/ai/portfolio-bio'
    }
];
